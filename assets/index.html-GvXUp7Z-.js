import{_ as t,r as p,o,c as r,b as n,d as s,e,a as l}from"./app-mjq2AL_n.js";const i="/assets/eslint-features-img-900w-dibTBFYO.webp",c={},d=n("p",null,"用一句话概括 eslint 和 prettier 的区别:",-1),u=n("p",null,"Prettier for formatting and linters for catching bugs!",-1),m={href:"https://prettier.io/docs/en/comparison",target:"_blank",rel:"noopener noreferrer"},k={href:"https://eslint.org/",target:"_blank",rel:"noopener noreferrer"},v={href:"https://prettier.io/",target:"_blank",rel:"noopener noreferrer"},b=l('<img src="'+i+`" width="50%" alt="Eslint的特性"><h2 id="_1-prettier-的使用" tabindex="-1"><a class="header-anchor" href="#_1-prettier-的使用" aria-hidden="true">#</a> 1. Prettier 的使用</h2><p>Prettier 的本质作用就是格式化代码，没有其他的副作用。 Prettier 有两种使用方式，你既可以在一个<strong>标准的 Nodejs 项目</strong>中使用它，也可以在<strong>不含 Nodejs 的项目中</strong>使用它。</p><h3 id="在-nodejs-项目中" tabindex="-1"><a class="header-anchor" href="#在-nodejs-项目中" aria-hidden="true">#</a> 在 Nodejs 项目中</h3><p>TODO</p><h3 id="在非-nodejs-项目中" tabindex="-1"><a class="header-anchor" href="#在非-nodejs-项目中" aria-hidden="true">#</a> 在非 Nodejs 项目中</h3><p>在非 Nodejs 项目中，由于缺少 nodejs 环境，无法通过命令格式化文件。此时的格式化是依赖于编辑器的。例如在 vscode 中，需要安装扩展插件<code>esbenp.prettier-vscode</code>。并在<code>./.vscode/settings.json</code>中加入如下配置，使得 prettier 插件能生效。</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-eslint-的使用" tabindex="-1"><a class="header-anchor" href="#_2-eslint-的使用" aria-hidden="true">#</a> 2. Eslint 的使用</h2><p>TODO</p>`,12);function h(y,g){const a=p("ExternalLinkIcon");return o(),r("div",null,[d,n("blockquote",null,[u,n("p",null,[s("---- come from "),n("a",m,[s("prettier.io"),e(a)])])]),n("p",null,[s("此处放置 "),n("a",k,[s("Eslint"),e(a)]),s(" 和 "),n("a",v,[s("Prettier"),e(a)]),s(" 的官网地址。")]),b])}const _=t(c,[["render",h],["__file","index.html.vue"]]);export{_ as default};
